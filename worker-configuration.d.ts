/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 4af14296760e7a12170b058213eec8d1)
// Runtime types generated with workerd@1.20260508.1 2024-10-21 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "TradingAgent";
	}
	interface Env {
		AI: Ai;
		MCP_SERVER_URL: "https://stock-mcp.durgadas.in/mcp";
		BASE_URL: "https://cf-stock-trading-agent.durgadas.in";
		TRADING_AGENT: DurableObjectNamespace<import("./src/index").TradingAgent>;
		TRADING_WORKFLOW: Workflow<Parameters<import("./src/index").TradingWorkflow['run']>[0]['payload']>;
		WATCHLIST_ANALYSIS_WORKFLOW: Workflow<Parameters<import("./src/index").WatchlistAnalysisWorkflow['run']>[0]['payload']>;
	}
}
